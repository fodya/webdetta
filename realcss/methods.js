...
/**
 * @typedef {(v: unknown) => unknown} MethodsResolver
 */

/**
 * @typedef {MethodsResolver | Record<string, unknown> | readonly unknown[] | undefined} MethodConfigEntry
 */

/**
 * @typedef {Record<string, MethodsResolver>} MethodsResolvers
 */

/**
 * @typedef {Record<string, MethodFn>} MethodsMap
 */

/**
 * @typedef {Object.<string, MethodConfigEntry> & {
 ...
 * @returns {{ methods: MethodsMap; resolve: MethodsResolvers }}
 */
