...
const parsePathParam = (part) => part.startsWith(":") ? part.slice(1) : null;
...
/**
 * @template V
 * @param {Record<string, [string, V]>} routes
 * @returns {Record<string, ParsedRoute<V>>}
 */
...
/**
 * @template V
 * @param {ParsedRoute<V>[]} routesList
 * @param {RouterLocation} loc
 * @returns {RouteMatch<V>}
 */
